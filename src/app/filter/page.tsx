...
export default function FilterPage() {
    ...
    const { filters, updateFilters, resetFilters: resetGlobalFilters } = useUser();
    ...
    const handleToggleAllGenders = () => {
        setLocalFilters(prev => ({
            ...prev,
            gender: prev.gender.length > 0 ? [] : ['남성', '여성', '기타']
        }));
    };
    ...
    const handleReset = () => {
        resetGlobalFilters();
        // The context useEffect will update localStorage, so we just need to reset local state.
